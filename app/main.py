...
async def lifespan(_app: FastAPI):
    ...
    try:
        ...
        print(f"[SAC] seed_tech_team_if_missing ignoré: {exc}")
    try:
...
app.include_router(edb.router, prefix="/api")
...
app.include_router(dev_center.router, prefix="/api")

app.include_router(tech_manager.router, prefix="/api")
